...
class VITONDataset(data.Dataset):
    ...
    def get_img_agnostic(self, img, parse, pose_data):
        ...
        length_a = np.linalg.norm(pose_data[5] - pose_data[2]) # chiều dài vai
        length_b = np.linalg.norm(pose_data[12] - pose_data[9]) # chiều dài eo
        point = (pose_data[9] + pose_data[12]) / 2 # trung điểm 
    ...
    def __getitem__(self, index):
        ...
        name = osp.join(self.data_path, 'openpose-img', pose_name)
        ...
        # print("img_agn",img_agnostic.shape)
        ...
        # print("res.cuda=",result['pose'].cuda)
        return result
